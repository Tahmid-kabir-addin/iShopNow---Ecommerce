...
const Header = () => {
  ...
  //               <li><a class="hover:text-gray-200" href="/about">About Us</a></li>
  //             </ul>
  ...
  //                 </svg>
  //               </a> */}
  //               <a class="hover:text-gray-200" href="/search">
  //                 <svg class="cursor-pointer bi bi-search" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
